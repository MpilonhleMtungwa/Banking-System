...
function updateBalanceAndTransactions() {
  fetch(
    "https://banking-system-1y6z54so9-mpilonhle-s-projects.vercel.app/api/getBalanceAndTransactions"
  )
    .then((response) => {
      if (!response.ok) {
...
document.addEventListener("DOMContentLoaded", function () {
  fetch(
    "https://banking-system-1y6z54so9-mpilonhle-s-projects.vercel.app/api/lastWithdrawal"
  )
    .then((response) => {
      if (!response.ok) {
